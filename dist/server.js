...
const sseManagerClients = new Map();
...
global.notifyManagerAssignmentUpdate = (userId) => {
...
if (process.env.NODE_ENV !== 'production') {
    app.get('/api/dev/token', (req, res) => {
        try {
            ...
            const userId = req.query.userId || 'user_owner_a';
            const tenantId = req.query.tenantId || 'client_a';
            const role = req.query.role || 'business_owner';
