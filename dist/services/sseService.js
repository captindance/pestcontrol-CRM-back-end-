...
export const sseAdminClients = new Set();
// SSE: store connected managers by userId for assignment updates
export const sseManagerClients = new Map();
...
export function notifyManagerAssignmentUpdate(userId) {
...
// Setup SSE endpoints
export function setupSSEEndpoints(app) {
...
global.notifyManagerUpdate = notifyManagerUpdate;
global.notifyManagerAssignmentUpdate = notifyManagerAssignmentUpdate;
